...
//Route::group(['prefix'=>'admin','as'=>'admin.'], function(){
  ...
  //Route::get('/', ['as' => 'index', function () {
    //         return view('admin/index');
      //           }]);
  //Route::get('/edit/{id}', ['as' => 'edit', function () {
...
Route::group(['prefix' => 'admin'], function() { Route::get('', [
'uses' => 'PostController@getAdminIndex',
'as' => 'admin.index' ]);
Route::get('create', [
'uses' => 'PostController@getAdminCreate', 'as' => 'admin.create'
]);
Route::post('create', [
'uses' => 'PostController@postAdminCreate', 'as' => 'admin.create'
]);
Route::get('edit/{id}', [
'uses' => 'PostController@getAdminEdit', 'as' => 'admin.edit'
]);
Route::post('edit', [
'uses' => 'PostController@postAdminUpdate', 'as' => 'admin.update'
]); });
